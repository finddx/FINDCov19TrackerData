    ...
    if argv[1:]:
        ...
        for a in argv[1:]:
            if a not in countries:
                print('USAGE:')
                print('\t%s <country1> <country2> ...' % argv[0])
                print('\t- to test country1 country2 ....')
                print('or')
                print('\t%s' % argv[0])
                print('\t- to test all countries')
                print('Valid country names:')
                print('\n'.join(countries))
                assert a in countries, a + ' not in ' + str(countries)
        countries = set(argv[1:])
