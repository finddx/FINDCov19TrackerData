...
The FIND team collects test data on a daily basis, from information found online. It combines it with case and deaths data from John Hopkins University and display them in an [interactive tracker dashboard](https://www.finddx.org/covid-19/test-tracker).
...
- [`processed/data_all.csv`](https://github.com/finddx/FINDCov19TrackerData/blob/master/processed/data_all.csv): Test data combined with case and deaths data from John Hopkins University, including group aggregations. This data is shown in the [interactive tracker dashboard](https://www.finddx.org/covid-19/test-tracker).


## Sources

**Test data** : Collated everyday by the FIND team, from information found online.
A large portion is automated via Python and R (see below).
...
A final step combines case and test data, and aggregates data to groups:
