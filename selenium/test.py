...
class TestDefaultSuite(unittest.TestCase):
  ...
  def test_peru(self):
    ...
    self.driver.get("https://app.powerbi.com/view?r=eyJrIjoiMDVlYmEwYjAtM2UzOC00N2IxLWJlNTEtZWZhMTEyMzZhODFjIiwidCI6IjM0MGJjMDE2LWM2YTYtNDI2Ni05NGVjLWE3NDY0YmY5ZWM3MCIsImMiOjR9")
    self.driver.set_page_load_timeout(40)
    self.driver.implicitly_wait(40)
  ...
  def test_singapore(self):
    ...
    time.sleep(10)
    self.vars["rapid_test_cum"] = self.driver.find_element(By.XPATH, "/html/body/form/main/section/section/div/div/div[2]/div/div[13]/div[2]/div[1]/div[2]/div[1]/div/div[1]/div/table/tbody/tr[2]/td/font/span/b").text.replace(',','')
    self.driver.find_element_by_xpath("/html/body/form/main/section/section/div/div/div[2]/div/div[13]/div[1]/ul/li[2]/span").click()
    self.vars["pcr_tests_cum"] = self.driver.find_element(By.XPATH, "/html/body/form/main/section/section/div/div/div[2]/div/div[13]/div[2]/div[2]/div[2]/div[1]/div/div/div[1]/table/tbody/tr[2]/td/font/span/b").text.replace(',','')
    self.vars["tests_cumulative"] = int(self.vars["pcr_tests_cum"])+int(self.vars["rapid_test_cum"])
    print("Singapore")
    print(self.vars)
    self.driver.close()
